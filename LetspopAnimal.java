...
public class LetspopAnimal implements ActionListener,KeyListener
{
    JFrame mainFrame;
    ...
    public void setBoard() {
        ...
        Color background=new Color(236,150,163);
        ...
        try{
            Image imageheader = ImageIO.read(new File("animal/header.png"));
        ...
        for(int columns = 0; columns < 6; columns++) {
            for(int rows = 0; rows < 5; rows++) {
                ...
                tileButton[columns][rows].addKeyListener(this);
        ...
        reassembleButton.addKeyListener(this);
