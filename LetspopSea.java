...
public class LetspopSea implements ActionListener
{
    JFrame mainFrame;
    ...
    public void setBoard() {
        ...
        Color background=new Color(122,155,201);
        ...
        try{
            Image imageheader = ImageIO.read(new File("sealife/header.png"));
