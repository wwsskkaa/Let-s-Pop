...
public class LetspopCar implements ActionListener
{
    JFrame mainFrame;
    ...
    public void setBoard() {
        ...
        Color background=new Color(255,220,73);
        ...
        try{
            Image imageheader = ImageIO.read(new File("transportation/header.png"));
...
private static class CustomizedButton extends JButton implements ActionListener {
     ...
     public CustomizedButton(String t) {
        ...
        imagesource="transportation/"+text+".png";
